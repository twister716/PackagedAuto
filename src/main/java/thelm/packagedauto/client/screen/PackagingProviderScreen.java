...
public class PackagingProviderScreen extends BaseScreen<PackagingProviderMenu> {
	...
	class ButtonChangeProvideDirect extends AbstractWidget {
		...
		@Override
		public void renderToolTip(PoseStack poseStack, int mouseX, int mouseY) {
			renderTooltip(poseStack, Component.translatable("block.packagedauto.packaging_provider.direct."+menu.blockEntity.provideDirect), mouseX, mouseY);
		}
	...
	class ButtonChangeProvidePackaging extends AbstractWidget {
		...
		@Override
		public void renderToolTip(PoseStack poseStack, int mouseX, int mouseY) {
			renderTooltip(poseStack, Component.translatable("block.packagedauto.packaging_provider.packaging."+menu.blockEntity.providePackaging), mouseX, mouseY);
		}
	...
	class ButtonChangeProvideUnpackaging extends AbstractWidget {
		...
		@Override
		public void renderToolTip(PoseStack poseStack, int mouseX, int mouseY) {
			renderTooltip(poseStack, Component.translatable("block.packagedauto.packaging_provider.unpackaging."+menu.blockEntity.provideUnpackaging), mouseX, mouseY);
		}
