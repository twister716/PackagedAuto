...
public class PackagerExtensionScreen extends BaseScreen<PackagerExtensionContainer> {

	public static final ResourceLocation BACKGROUND = new ResourceLocation("packagedauto:textures/gui/packager_extension.png");

	public PackagerExtensionScreen(PackagerExtensionContainer container, PlayerInventory playerInventory, ITextComponent title) {
