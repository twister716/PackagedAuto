...
public class PackagingProviderMenu extends BaseMenu<PackagingProviderBlockEntity> {
	...
	public static final MenuType<PackagingProviderMenu> TYPE_INSTANCE = (MenuType<PackagingProviderMenu>)IForgeMenuType.
			create(new PositionalBlockEntityMenuFactory<>(PackagingProviderMenu::new)).
