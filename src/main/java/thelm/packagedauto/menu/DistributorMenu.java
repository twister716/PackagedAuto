...
public class DistributorMenu extends BaseMenu<DistributorBlockEntity> {
	...
	public static final MenuType<DistributorMenu> TYPE_INSTANCE = (MenuType<DistributorMenu>)IForgeMenuType.
			create(new PositionalBlockEntityMenuFactory<>(DistributorMenu::new)).
